    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend' => 'Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href="' . route('account.confirm.resend', ':school', ':token') . '">click here</a> to resend the confirmation e-mail.',
